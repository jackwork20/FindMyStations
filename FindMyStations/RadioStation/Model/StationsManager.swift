...
class StationsManager {
    ...
    func fetch(loadMore: Bool = false, loadPage: Int = 1, _ completion: StationsCompletion? = nil) {
        DataManager.getStation (loadMore: loadMore, loadPage: loadPage) { [weak self] result in
